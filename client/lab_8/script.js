...
// Crreates Map
function initMap() {
  const map = L.map("mymap").setView([38.9897, -76.9378], 13);
  L.tileLayer(
...
async function mainEvent() {
  ...
  const restNameInput = document.querySelector("#resto_name");
  const zipCodeInput = document.querySelector("#food_type");
